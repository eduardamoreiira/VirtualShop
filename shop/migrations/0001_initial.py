# Generated by Django 5.1.2 on 2024-10-10 01:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['nome'],
                'indexes': [models.Index(fields=['id', 'slug'], name='shop_produt_id_f0c390_idx'), models.Index(fields=['nome'], name='shop_produt_nome_41875d_idx'), models.Index(fields=['-criado'], name='shop_produt_criado_216a81_idx')],
            },
        ),
    ]
